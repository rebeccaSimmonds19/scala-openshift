...
object weatherTree {
  ...
  def main(args: Array[String]): Unit = {
    val weather = read.arff("/Users/rebeccasimmonds/git_projects/java-snake/irisData/src/data/weather.nominal.arff", 4)
    ...
    val weatherTest = read.arff("/Users/rebeccasimmonds/git_projects/java-snake/irisData/src/data/weatherTest.nominal.arff", 4)
